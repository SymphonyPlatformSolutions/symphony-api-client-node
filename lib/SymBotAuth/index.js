...
SymBotAuth.sessionAuthenticate = (symConfig) => {
  ...
  if (symConfig.authType === 'rsa') {
    ...
    options = {
      ...
      'path': PathBuilder.buildPodPath('login/pubkey/authenticate', symConfig),
      'method': 'POST',
      'headers': {
    ...
    options = {
      ...
      'path': PathBuilder.buildSessionAuthPath('/sessionauth/v1/authenticate', symConfig),
      'method': 'POST',
...
SymBotAuth.kmAuthenticate = (symConfig) => {
  ...
  if (symConfig.authType === 'rsa') {
    ...
    options = {
      ...
      'path': PathBuilder.buildKeyAuthPath('/relay/pubkey/authenticate', symConfig),
      'method': 'POST',
      'headers': {
        'Content-Type': 'application/json',
        'Cache-Control': 'no-cache'
    ...
    options = {
      'hostname': symConfig.keyAuthHost,
      'port': symConfig.keyAuthPort,
      'path': PathBuilder.buildKeyAuthPath('/keyauth/v1/authenticate', symConfig),
      'method': 'POST',
      'pfx': fs.readFileSync(symConfig.botCertPath + symConfig.botCertName),
      'passphrase': symConfig.botCertPassword,
      'agent': symConfig.keyManagerProxy
...
SymBotAuth.extAppAuthenticate = (symConfig) => {
  ...
  if (symConfig.authType === 'rsa') {
    ...
    options = {
      'hostname': symConfig.podHost,
      'port': symConfig.podPort,
      'path': PathBuilder.buildPodPath('/login/v1/pubkey/app/authenticate/extensionApp'),
      'method': 'POST',
      'headers': {
        'Content-Type': 'application/json',
        'Cache-Control': 'no-cache'
    ...
    options = {
      'hostname': symConfig.sessionAuthHost,
      'port': symConfig.sessionAuthPort,
      'path': PathBuilder.buildSessionAuthPath('/sessionauth/v1/authenticate/extensionApp'),
      'method': 'POST',
...
SymBotAuth.oboAppAuthenticate = (symConfig) => {
  ...
  if (symConfig.authType === 'rsa') {
    ...
    options = {
      'hostname': symConfig.podHost,
      'port': symConfig.podPort,
      'path': PathBuilder.buildPodPath('/login/pubkey/app/authenticate'),
      'method': 'POST',
      'headers': {
        'Content-Type': 'application/json',
        'Cache-Control': 'no-cache'
    ...
    options = {
      'hostname': symConfig.sessionAuthHost,
      'port': symConfig.sessionAuthPort,
      'path': PathBuilder.buildSessionAuthPath('/sessionauth/v1/app/authenticate'),
      'method': 'POST',
      'pfx': fs.readFileSync(symConfig.appCertPath + symConfig.appCertName),
      'passphrase': symConfig.appCertPassword,
      'agent': symConfig.podProxy
...
SymBotAuth.oboAuthenticateByUserId = async (userId) => {
  ...
  if (SymBotAuth.symConfig.authType === 'rsa') {
    ...
    options = {
      ...
      'path': PathBuilder.buildPodPath('/login/pubkey/app/user/' + userId + '/authenticate'),
      'method': 'POST',
      'headers': {
    ...
    options = {
      ...
      'path': PathBuilder.buildSessionAuthPath('/sessionauth/v1/app/user/' + userId + '/authenticate'),
      'method': 'POST',
      'headers': {
        'sessionToken': oboSessionToken
      },
...
SymBotAuth.oboAuthenticateByUsername = async (symConfig, username) => {
  ...
  if (symConfig.authType === 'rsa') {
    ...
    options = {
      'hostname': symConfig.podHost,
      'port': symConfig.podPort,
      'path': PathBuilder.buildPodPath('/login/pubkey/app/username/' + username + '/authenticate'),
      'method': 'POST',
      'headers': {
        'sessionToken': oboSessionToken,
        'Content-Type': 'application/json',
    ...
    options = {
      'hostname': symConfig.sessionAuthHost,
      'port': symConfig.sessionAuthPort,
      'path': PathBuilder.buildSessionAuthPath('/sessionauth/v1/app/username/' + username + '/authenticate'),
      'method': 'POST',
      'headers': {
        'sessionToken': oboSessionToken
      },
...
SymBotAuth.setupPodCertificate = async (symConfig) => {
  ...
  const options = {
    'hostname': symConfig.podHost,
    'port': symConfig.podPort,
    'path': PathBuilder.buildPodPath('/pod/v1/podcert'),
    'method': 'GET',
    'agent': symConfig.podProxy
  }
...
SymBotAuth.verifyJWT = async (symConfig, token) => {
  ...
  try {
    return jsonwebtoken.verify(token, SymBotAuth.podCertificate).user
  } catch (e) {
    return e
  }
}
...
SymBotAuth.initBotUser = (symConfig) => {
  var options = {
    'hostname': symConfig.podHost,
    'port': symConfig.podPort,
    'path': PathBuilder.buildPodPath('/pod/v2/sessioninfo'),
    'method': 'GET',
    'headers': {
  ...
  return request(options, 'SymBotAuth/initBotUser').then((botUser) => {
    SymBotAuth.botUser = botUser
...
SymBotAuth.getJwtToken = (symConfig, sub = symConfig.botUsername, signingKey) => {
  ...
  const token = jsonwebtoken.sign({sub: symConfig.botUsername}, signingKey, {algorithm: 'RS512', expiresIn: 3 * 60});
...
SymBotAuth.getAppJwtToken = (symConfig) => {
  const signingKey = fs.readFileSync(symConfig.appPrivateKeyPath + symConfig.appPrivateKeyName, 'utf8')
  return SymBotAuth.getJwtToken(symConfig, symConfig.appId, signingKey)
}
