...
SymBotAuth.sessionAuthenticate = (symConfig) => {
  ...
  if (symConfig.authType === 'rsa') {
    ...
    options = {
      ...
      'path': SymConfigLoader.SymConfig.pathPrefix + '/login/pubkey/authenticate',
      'method': 'POST',
      'headers': {
    ...
    options = {
      ...
      'path': SymConfigLoader.SymConfig.pathPrefix + '/sessionauth/v1/authenticate',
      'method': 'POST',
...
SymBotAuth.kmAuthenticate = (symConfig) => {
  ...
  if (symConfig.authType === 'rsa') {
    ...
    options = {
      ...
      'path': SymConfigLoader.SymConfig.pathPrefix + '/relay/pubkey/authenticate',
      'method': 'POST',
      'headers': {
        'Content-Type': 'application/json',
        'Cache-Control': 'no-cache'
    ...
    options = {
      'hostname': symConfig.keyAuthHost,
      'port': symConfig.keyAuthPort,
      'path': SymConfigLoader.SymConfig.pathPrefix + '/keyauth/v1/authenticate',
      'method': 'POST',
      'pfx': fs.readFileSync(symConfig.botCertPath + symConfig.botCertName),
      'passphrase': symConfig.botCertPassword,
      'agent': symConfig.keyManagerProxy
...
SymBotAuth.extAppAuthenticate = (symConfig) => {
  ...
  if (symConfig.authType === 'rsa') {
    ...
    options = {
      'hostname': symConfig.podHost,
      'port': symConfig.podPort,
      'path': SymConfigLoader.SymConfig.pathPrefix + '/login/v1/pubkey/app/authenticate/extensionApp',
      'method': 'POST',
      'headers': {
        'Content-Type': 'application/json',
        'Cache-Control': 'no-cache'
    ...
    options = {
      'hostname': symConfig.sessionAuthHost,
      'port': symConfig.sessionAuthPort,
      'path': SymConfigLoader.SymConfig.pathPrefix + '/sessionauth/v1/authenticate/extensionApp',
      'method': 'POST',
...
SymBotAuth.oboAppAuthenticate = (symConfig) => {
  ...
  if (symConfig.authType === 'rsa') {
    ...
    options = {
      'hostname': symConfig.podHost,
      'port': symConfig.podPort,
      'path': SymConfigLoader.SymConfig.pathPrefix + '/login/pubkey/app/authenticate',
      'method': 'POST',
      'headers': {
        'Content-Type': 'application/json',
        'Cache-Control': 'no-cache'
    ...
    options = {
      'hostname': symConfig.sessionAuthHost,
      'port': symConfig.sessionAuthPort,
      'path': SymConfigLoader.SymConfig.pathPrefix + '/sessionauth/v1/app/authenticate',
      'method': 'POST',
      'pfx': fs.readFileSync(symConfig.appCertPath + symConfig.appCertName),
      'passphrase': symConfig.appCertPassword,
      'agent': symConfig.podProxy
...
SymBotAuth.oboAuthenticateByUserId = async (userId) => {
  ...
  if (SymBotAuth.symConfig.authType === 'rsa') {
    ...
    options = {
      ...
      'path': SymConfigLoader.SymConfig.pathPrefix + '/login/pubkey/app/user/' + userId + '/authenticate',
      'method': 'POST',
      'headers': {
    ...
    options = {
      ...
      'path': SymConfigLoader.SymConfig.pathPrefix + '/sessionauth/v1/app/user/' + userId + '/authenticate',
      'method': 'POST',
      'headers': {
        'sessionToken': oboSessionToken
      },
...
SymBotAuth.oboAuthenticateByUsername = async (symConfig, username) => {
  ...
  if (symConfig.authType === 'rsa') {
    ...
    options = {
      'hostname': symConfig.podHost,
      'port': symConfig.podPort,
      'path': SymConfigLoader.SymConfig.pathPrefix + '/login/pubkey/app/username/' + username + '/authenticate',
      'method': 'POST',
      'headers': {
        'sessionToken': oboSessionToken,
        'Content-Type': 'application/json',
    ...
    options = {
      'hostname': symConfig.sessionAuthHost,
      'port': symConfig.sessionAuthPort,
      'path': SymConfigLoader.SymConfig.pathPrefix + '/sessionauth/v1/app/username/' + username + '/authenticate',
      'method': 'POST',
      'headers': {
        'sessionToken': oboSessionToken
      },
...
SymBotAuth.setupPodCertificate = async (symConfig) => {
  ...
  const options = {
    'hostname': symConfig.podHost,
    'port': symConfig.podPort,
    'path': SymConfigLoader.SymConfig.pathPrefix + '/pod/v1/podcert',
    'method': 'GET',
    'agent': symConfig.podProxy
  }
...
SymBotAuth.initBotUser = (symConfig) => {
  var options = {
    'hostname': symConfig.podHost,
    'port': symConfig.podPort,
    'path': SymConfigLoader.SymConfig.pathPrefix + '/pod/v2/sessioninfo',
    'method': 'GET',
    'headers': {
