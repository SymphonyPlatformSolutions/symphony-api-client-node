...
ConnectionsClient.getPendingConnections = (sessionToken) =>
  podRequest(
    'GET',
    SymConfigLoader.SymConfig.pathPrefix + '/pod/v1/connection/list?status=pending_outgoing',
...
ConnectionsClient.getInboundPendingConnections = (sessionToken) =>
  podRequest(
    'GET',
    SymConfigLoader.SymConfig.pathPrefix + '/pod/v1/connection/list?status=pending_incoming',
...
ConnectionsClient.getAllConnections = (sessionToken) =>
  podRequest(
    'GET',
    SymConfigLoader.SymConfig.pathPrefix + '/pod/v1/connection/list?status=all',
...
ConnectionsClient.getAcceptedConnections = (sessionToken) =>
  podRequest(
    'GET',
    SymConfigLoader.SymConfig.pathPrefix + '/pod/v1/connection/list?status=accepted',
...
ConnectionsClient.getRejectedConnections = (sessionToken) =>
  podRequest(
    'GET',
    SymConfigLoader.SymConfig.pathPrefix + '/pod/v1/connection/list?status=rejected',
...
ConnectionsClient.getConnections = (status, userIds, sessionToken) =>
  podRequest(
    'GET',
    SymConfigLoader.SymConfig.pathPrefix + `/pod/v1/connection/list?status=all?userIds=${userIds}`,
...
ConnectionsClient.acceptConnectionRequest = (userId, sessionToken) =>
  podRequest(
    'POST',
    SymConfigLoader.SymConfig.pathPrefix + '/pod/v1/connection/accept',
...
ConnectionsClient.rejectConnectionRequest = (userId, sessionToken) =>
  podRequest(
    'POST',
    SymConfigLoader.SymConfig.pathPrefix + '/pod/v1/connection/reject',
...
ConnectionsClient.sendConnectionRequest = (userId, sessionToken) =>
  podRequest(
    'POST',
    SymConfigLoader.SymConfig.pathPrefix + '/pod/v1/connection/create',
...
ConnectionsClient.removeConnection = (userId, sessionToken) =>
  podRequest(
    'POST',
    SymConfigLoader.SymConfig.pathPrefix + `/pod/v1/connection/user/${userId}/remove`,
...
ConnectionsClient.getConnectionRequestStatus = (userId, sessionToken) =>
  podRequest(
    'GET',
    SymConfigLoader.SymConfig.pathPrefix + `/pod/v1/connection/user/${userId}/info`,
