...
SignalsClient.listSignals = (skip = 0, limit = 50) => {
  ...
  var req = https.request(options, function (res) {
    ...
    res.on('end', function () {
      if (SymBotAuth.debug) {
        console.log('[DEBUG]', 'ConnectionsClient/listSignals/str', str)
      }
...
SignalsClient.getSignal = (id) => {
  ...
  var req = https.request(options, function (res) {
    ...
    res.on('end', function () {
      if (SymBotAuth.debug) {
        console.log('[DEBUG]', 'ConnectionsClient/getSignal/str', str)
      }
      defer.resolve(JSON.parse(str))
    })
  })
...
SignalsClient.createSignal = (name, query, visibleOnProfile = true, companyWide = false) => {
  ...
  var req = https.request(options, function (res) {
    ...
    res.on('end', function () {
      if (SymBotAuth.debug) {
        console.log('[DEBUG]', 'ConnectionsClient/createSignal/str', str)
      }
      defer.resolve(JSON.parse(str))
    })
  })
...
SignalsClient.updateSignal = (id, name, query, visibleOnProfile, companyWide) => {
  ...
  var req = https.request(options, function (res) {
    ...
    res.on('end', function () {
      if (SymBotAuth.debug) {
        console.log('[DEBUG]', 'ConnectionsClient/updateSignal/str', str)
      }
      defer.resolve(JSON.parse(str))
    })
  })
...
SignalsClient.deleteSignal = (id) => {
  ...
  var req = https.request(options, function (res) {
    ...
    res.on('end', function () {
      if (SymBotAuth.debug) {
        console.log('[DEBUG]', 'ConnectionsClient/deleteSignal/str', str)
      }
      defer.resolve(JSON.parse(str))
    })
  })
...
SignalsClient.subscribeSignal = (id, userIds, userCanUnsubscribe) => {
  ...
  var req = https.request(options, function (res) {
    ...
    res.on('end', function () {
      if (SymBotAuth.debug) {
        console.log('[DEBUG]', 'ConnectionsClient/subscribeSignal/str', str)
      }
      defer.resolve(JSON.parse(str))
    })
  })
...
SignalsClient.unsubscribeSignal = (id, userIds) => {
  ...
  var req = https.request(options, function (res) {
    ...
    res.on('end', function () {
      if (SymBotAuth.debug) {
        console.log('[DEBUG]', 'ConnectionsClient/unsubscribeSignal/str', str)
      }
      defer.resolve(JSON.parse(str))
    })
  })
...
SignalsClient.getSignalSubscribers = (id, skip = 0, limit = 50) => {
  ...
  var req = https.request(options, function (res) {
    ...
    res.on('end', function () {
      if (SymBotAuth.debug) {
        console.log('[DEBUG]', 'ConnectionsClient/getSignalSubscribers/str', str)
      }
      defer.resolve(JSON.parse(str))
    })
  })
